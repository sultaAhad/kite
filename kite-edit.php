...
<?php include 'inc/siderbar.php'; ?>            </div>
            <div class="col-lg-8">
                <div class="my-profile-wrapper h-100">
                    <h3 class="heading-italic-font text-white mb-3">Edit Profile</h3>
                    ...
                    <form action="" method="POST">
                        <div class="row g-4">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control custom-dark-input" value="Alexander" required>
                            </div>
                            <div class="col-md-6">
                                <label class="profile-info-label">Last Name</label>
                                <input type="text" class="form-control custom-dark-input" value="Volk" required>
                            </div>
                            <div class="col-md-12">
                                <label class="profile-info-label">Email Address</label>
                                <input type="email" class="form-control custom-dark-input" value="John Williams@gmail.com" required>
                            </div>
                            <div class="col-md-12">
                                <label class="profile-info-label">Address</label>
                                <textarea class="form-control custom-dark-input" rows="3">Lorem ipsum dolor sit amet, consectetur adipiscing elit,</textarea>
                            </div>
                            <div class="col-12 mt-4">
                                <button type="submit" class="btn-orange-gradient-pill">Save Changes</button>
...
textarea.custom-dark-input { border-radius: 15px; }
