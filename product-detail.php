...
<style>
    ...
    .quantity-counter {
        display: flex;
        align-items: center;
        background-color: #ffffff; /* Background white kar diya gaya hai */
    ...
    .quantity-counter button {
        background: none;
        border: none;
        color: #000; /* Dark text/icons for white background */
        font-size: 16px;
        cursor: pointer;
        font-weight: bold;
    }
                ...
                <div class="shop-detail-slider-wrap">
                    ...
                    <div class="swiper shop-thumbs-swiper">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide"><img src="img/product.png" alt="Thumb 1"></div>
                    ...
                    <div class="swiper shop-main-swiper">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide"><img src="img/product.png" alt="Main Kite 1"></div>
